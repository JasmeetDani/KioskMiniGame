...
namespace UnityEngine.UI.Extensions
{
    ...
    public class AutoCompleteComboBox : MonoBehaviour
    {
        ...
        private List<string> _panelItems; //items that will get shown in the dropdown by consulting _panelItemsMaster
        private Dictionary<string, string> _panelItemsMaster;
        ...
        // Any way to disable UI for below if SelectFirstItemOnStart is selected ???, TODO:Revisit
        ...
        public void OnEnable()
        {
            if (AvailableOptions.Count > 0)
            {
                ...
                OnItemClicked(AvailableOptions[DefaultIndex]);
            }
        }
        public void Start()
		{
        ...
        private bool Initialize()
        {
            ...
            _panelItemsMaster = new Dictionary<string, string>();
        ...
        */
        ...
        private void RebuildPanel()
        {
            ...
            foreach (string option in AvailableOptions)
            {
                ...
                _panelItemsMaster.Add(option.ToLower(), option);
            }
            ...
            for (int i = 0; i < itemObjs.Count; i++)
            {
                ...
                {
                    itemObjs[i].name = "Item " + i + " " + _panelItemsMaster[_panelItems[i]];
                    itemObjs[i].transform.Find("Text").GetComponent<Text>().text = _panelItemsMaster[_panelItems[i]]; //set the text value

                    Button itemBtn = itemObjs[i].GetComponent<Button>();
                    itemBtn.onClick.RemoveAllListeners();
                    string textOfItem = _panelItemsMaster[_panelItems[i]]; //has to be copied for anonymous function or it gets garbage collected away
